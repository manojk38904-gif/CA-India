    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <a href="#programs" style={{ textDecoration: 'none', color: '#0f172a' }}>Programs</a>
            <a href="#impact" style={{ textDecoration: 'none', color: '#0f172a' }}>Impact</a>
            <a href="#services" style={{ textDecoration: 'none', color: '#0f172a' }}>Services</a>
      ...
      <section id="about" style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
          ...
          >
            <div style={{ fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', color: '#1d4ed8' }}>
              About Us
            </div>
      ...
      <section id="impact" style={{ background: '#020617', color: 'white', padding: '80px 24px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ maxWidth: '700px' }}>
            <div style={{ fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', color: '#6ee7b7' }}>
              Impact
            </div>
            <h2 style={{ marginTop: '12px', fontSize: '40px', fontWeight: 800 }}>
          ...
          >
            <div style={{ display: 'grid', gap: '18px', fontSize: '15px', color: '#334155' }}>
              ...
              <div>
                ...
                <a href="https://www.instagram.com/collectiveactionindia/?hl=en" target="_blank" rel="noreferrer">
                  @collectiveactionindia
                </a>
              </div>
              <div>
                <div style={{ fontWeight: 800, color: '#0f172a' }}>Facebook</div>
                <a href="https://www.facebook.com/profile.php?id=61588352289456" target="_blank" rel="noreferrer">
